---
title: 'Python SDK'
description: "Summary of Wetrocloud's Python SDK `wetro` "
---
#### Wetrocloud PYTHON SDK
...
rag_client.collection.create_collection("research_papers")
...
try:
    response = client.rag.collection.query(collection_id="my_unique_collection_id", request_query="What is this article about?")
...
#### `collection.chat(message, chat_history=None, model=None, stream=False)`
