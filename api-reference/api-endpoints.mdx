...
#### Create Collection Endpoint (`/collection/create/`) <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
...
#### Insert Endpoint (`/resource/insert/`)  <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
<Frame>
  <img
...
#### Delete Collection Endpoint (`/collection/delete/`)  <img src="/logo/DELETE.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
