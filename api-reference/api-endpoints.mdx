...
#### Create Endpoint (`/create/`) <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
...
#### Insert Endpoint (`/insert/`)  <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
<Frame>
  <img
...
#### Query Endpoint (`/query/`)  <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
...
#### Delete Endpoint (`/delete/`)  <img src="/logo/DELETE.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
...
#### Categorize Endpoint (`/category/`) <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
...
#### Web Scrape Endpoint (`/scrape/`) <img src="/logo/POST.svg" style={{ display: 'inline',verticalAlign: 'middle'}} />
