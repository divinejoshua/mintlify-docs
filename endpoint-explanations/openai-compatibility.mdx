...
We supports a multiple of models from OpenAI, Anthopic, Meta etc. Visit [Wetrocloud supported models list](https://console.wetrocloud.com/) to check out our supported models.
...
<Steps>
  ...
  <Step title="Configuration">
    ...
    client = openai.OpenAI(
        ...
        api_key=os.environ.get("WETROCLOUD_API_KEY")
    )
    ```
    </CodeGroup>
  </Step>
