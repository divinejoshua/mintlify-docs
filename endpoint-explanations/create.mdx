...
<Info>
  At a glance: <br />
  This endpoint allows you to generate a unique `collection_id`. You would use this
  `collection_id` to insert, query and delete a resource.
</Info>
...
<Note>
  Before you begin!
  <br />
  Visit the [Wetrocloud console](https://console.wetrocloud.com/) to get your
  API key. If you have trouble obtaining it, refer to this
  [guide](/how-to-access-your-API-Key).
</Note>
