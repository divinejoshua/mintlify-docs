...
A collection in the WetroCloud API acts as a container for resources such as text, files and the other [supported resource types](/api-reference/supported-resource-types). Every collection is identified by a unique `collection_id`.
...
- **[List Collections](list-collections)**: Displays list of all your existing collections on wetrocloud.
