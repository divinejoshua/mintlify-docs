...
<Note>
Before you go on!<br />
Note that some of these models (Our [Premium Models](/endpoint-explanations/models#premium-models)) are not accessible to users via our free tokens, to access it you can buy tokens on [Wetrocloud console](https://console.wetrocloud.com/billing), [Click here to view our premium models](/endpoint-explanations/models#premium-models)
</Note>
...
|--------------------------|----------------------------|-------------|
| meta-llama/llama-4-scout-17b-16e-instruct    | meta-llama/llama-4-scout-17b-16e-instruct      | 17B active parameters and 109B total parameters. |
...
## **Premium Models**  
The following models are not available to developers using our free tokens 
...
# Models Usage
You can use these models in our [Query endpoint](/endpoint-explanations/query), [Chat endpoint](/endpoint-explanations/chat), [Text Generation endpoint](/endpoint-explanations/text-generation) and [OpenAI Compatibility endpoints](/endpoint-explanations/openai-compatibility)
...
<CodeGroup>
  ```bash cURL
    curl --request POST \
      ...
      --form 'model=claude-3-7-sonnet-20250219' \
  ...
  ```javascript JavaScript
    ...
    formData.append('model', 'claude-3-7-sonnet-20250219');
