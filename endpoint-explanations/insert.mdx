...
Use the `/v1/collection/insert/` endpoint when you need to:
...
To insert a resource into a collection, make a `POST` request to the `/v1/collection/insert/` endpoint with the required parameters in the body.
